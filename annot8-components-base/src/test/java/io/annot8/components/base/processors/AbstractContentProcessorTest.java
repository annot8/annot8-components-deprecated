...
public class AbstractContentProcessorTest {
    ...
    private final static String SHOULD_PROCESS = "SHOULD_PROCESS";
    private final static String NOT_PROCESS = "NOT_PROCESS";

    @Test
    public void testProcessItemWithSettings(){
        AbstractContentProcessor.ContentAnnotatorSettings settings = Mockito.mock(AbstractContentProcessor.ContentAnnotatorSettings.class);
    ...
    public void testContentAnnotatorSettings(){
        AbstractContentProcessor.ContentAnnotatorSettings settings
                = new AbstractContentProcessor.ContentAnnotatorSettings(Collections.singleton(SHOULD_PROCESS));
