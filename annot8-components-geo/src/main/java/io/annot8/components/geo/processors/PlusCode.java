...
public class PlusCode extends AbstractRegex {
  ...
  public PlusCode(){
    super(Pattern.compile("\\b([23456789C][23456789CFGHJMPQRV][23456789CFGHJMPQRVWX]{6}\\+[23456789CFGHJMPQRVWX]{2,3})\\b", Pattern.CASE_INSENSITIVE),
        0,
  ...
  protected boolean acceptMatch(Matcher m) {
    return OpenLocationCode.isValidCode(m.group()) &&
           OpenLocationCode.isFullCode(m.group());
  }
