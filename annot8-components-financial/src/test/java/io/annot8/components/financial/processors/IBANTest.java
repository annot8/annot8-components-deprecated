...
public class IBANTest {
  ...
  public void testInvalidIBAN() throws Annot8Exception {
    try(
      ...
      Text content = item.create(TestStringContent.class).withName("test")
          .withData("These are not valid IBANs: DE45 5001 0517 5407 3249 31 or GB29NWBK60161331926818").save();
  ...
  public void testIBAN() throws Annot8Exception {
    try(
      ...
      Text content = item.create(TestStringContent.class).withName("test")
          .withData("Some valid IBANs given by Wikipedia are: DE44 5001 0517 5407 3249 31, gr 16 0110 1250 0000 0001 2300 695, GB29NWBK60161331926819 and SA03 8000 0000 6080 1016 7519.").save();
      ...
      List<String> ibans = new ArrayList<>(Arrays.asList("DE44 5001 0517 5407 3249 31",
      ...
      for(Annotation a : annotations){
        ...
        if(code.startsWith("DE")){
          Assertions.assertEquals("5407324931", props.get(PropertyKeys.PROPERTY_KEY_ACCOUNTNUMBER).get());
          ...
          Assertions.assertEquals("0000000012300695", props.get(PropertyKeys.PROPERTY_KEY_ACCOUNTNUMBER).get());
          ...
          Assertions.assertEquals("31926819", props.get(PropertyKeys.PROPERTY_KEY_ACCOUNTNUMBER).get());
          ...
          Assertions.assertEquals("000000608010167519", props.get(PropertyKeys.PROPERTY_KEY_ACCOUNTNUMBER).get());
          Assertions.assertFalse(props.get(PropertyKeys.PROPERTY_KEY_BRANCHCODE).isPresent());
